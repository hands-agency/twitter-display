$(document).ready(function()
{
	...
	$twitterdisplay.html(
			'<div class="bloc-media"><div class="slickyy slicky-media"></div></div>'
		+	'<div class="bloc-text"><div class="slickyy slicky-text"></div></div>'
	);

	// Requete Ajax all tweet
	$.get('/tweetsdisplay',function(data){
		console.log(data);
		var i = 0;
